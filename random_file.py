...
class RandomFile:
    ...
    def get_files(self):
        ...
        for root, _, filenames in os.walk(self.directory):
            for filename in filenames:
                if filename.endswith(tuple(self.type_to_extension())) and not filename.startswith('.'):
    ...
    def type_to_extension(self):
        ...
        if self.file_type in types:
            ...
            raise ValueError(f"Unsupported file type '{self.file_type}'. Choose from 'audio', 'video', or 'image'.")
